...
import type { Offer, Comment, OfferShort } from '../../types/types';
...
export const getOffers = ({ [StoreSlice.SiteData]: SITE_DATA}: State): OfferShort[] => SITE_DATA.offers;

export const getIsFavoriteOffersLoading = ({ [StoreSlice.SiteData]: SITE_DATA }: State): boolean => SITE_DATA.isFavoriteOffersLoading;
export const getFavoriteOffers = ({ [StoreSlice.SiteData]: SITE_DATA}: State): OfferShort[] => SITE_DATA.favoriteOffers;
...
export const getPremiumOffers = ({ [StoreSlice.SiteData]: SITE_DATA }: State): OfferShort[] => SITE_DATA.premiumOffers;
