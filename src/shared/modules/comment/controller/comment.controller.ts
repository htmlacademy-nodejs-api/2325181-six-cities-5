...
import { CreateCommentRequestType, ParamCommentType, Component, CommentRdo, CommentService, CreateCommentRequestDTO, fillDTO, OfferService, Logger, BaseController, ValidateDtoMiddleware, HttpError, ValidateObjectIdMiddleware, DocumentExistsMiddleware, PrivateRouteMiddleware } from '../../../index.js';
